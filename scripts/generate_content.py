...
- 각 content 슬라이드는 정답을 주기보다 스스로 답을 채울 여지를 남기는 질문/짧은 통찰
  ...
  자연스럽게 읽히는 어투를 쓰세요.
- 위로에만 머무르지 말고, 읽는 사람이 피식 웃을 수 있는 "웃음 포인트"를 cover 또는
  content 슬라이드 중 최소 한 곳에 넣으세요. 스스로도 겪어봤을 법한 상황을 살짝 과장하거나
  엉뚱하지만 구체적인 비유로 표현하세요 (예: "이불 밖은 위험해" 대신 "이불이 저를 완전히
  흡수해버린 게 분명해요" 처럼). 무겁고 진지하기만 한 위로보다, 예상 밖의 웃긴 디테일이
  하나 섞여 있을 때 오히려 더 진짜처럼 느껴지고 저장·공유하고 싶어집니다. 유머가 위로의
  진정성을 해치지 않도록, 자기 비하나 냉소가 아니라 애정 어린 과장에 머무르세요.
- 각 content 슬라이드의 body는 2~4문장, 슬라이드당 최대 90자 내외로 간결하게.
- caption 마지막 문단에는 가볍게 웃을 수 있는 드립이나 위트 있는 한 줄을 넣어 마무리
  분위기가 무겁지 않게 하세요.
