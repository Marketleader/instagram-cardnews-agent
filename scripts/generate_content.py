...
- 이 계정은 실제 정부/지자체 지원 제도를 다룹니다. 구체적인 금액, 지원 대상 나이, 소득 기준,
  ...
  단정적으로 제시하지 마세요.
- 어조는 "친구가 알려주는 꿀팁"처럼 친근하되, 신뢰감 있게 작성하세요. 가르치거나 다그치는
  어투("꼭 챙기세요!", "반드시 확인하세요!" 같은 명령형)보다는, "이런 방법도 있으니 한번
  살펴보셔도 좋아요" 식으로 따뜻하게 권유하는 어투를 우선하세요. 독자를 20~30대 자취생으로만
  한정하지 말고, 실질적인 경제력이 있는 2030~40대에게도 자연스럽게 읽히는 어투를 쓰세요.
